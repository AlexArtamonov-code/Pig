...
//  Pig
//
//  Created by Alex Artamonov on 11/6/25.
//
    ...
    var body: some View {
        NavigationView{
            ...
            .alert(isPresented: $gameOver,content:{
                Alert(title: Text("You've won the game!"), dismissButton:
                ...
                VStack{
                    ...
                    VStack(alignment: .leading){
                        ...
                        Text("If a player rolls a pig they score nothing and it is the next player's turn.")
                            .padding()
                        Text("If the player rolls any other number, it is added to their turn total, and the player's turn.")
                            .padding()
                        Text("If the player chooses to \"hold\", their turn is added to the game score, and it becomes the next player's turn.")
                            .padding()
